...
*@FileName : CarrierMgmtDBDAOCarrierListVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class CarrierMgmtDBDAOCarrierListVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierMgmtDBDAOCarrierListVOCSQL(){
		setQuery();
		...
		query.append("FileName : CarrierMgmtDBDAOCarrierListVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
