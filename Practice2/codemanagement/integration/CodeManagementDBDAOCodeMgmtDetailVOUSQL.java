...
public class CodeManagementDBDAOCodeMgmtDetailVOUSQL implements ISQLTemplate{
	...
	public CodeManagementDBDAOCodeMgmtDetailVOUSQL(){
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.clv.doutraining.codemanagement.integration").append("\n"); 
	...
	public void setQuery(){
		...
		query.append("WHERE	INTG_CD_ID = @[intg_cd_id] and intg_cd_val_ctnt = @[intg_cd_val_ctnt]" ).append("\n"); 
